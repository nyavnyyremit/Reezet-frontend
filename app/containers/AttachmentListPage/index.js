...
class AttachmentListPage extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
...
const mapStateToProps = (state) => {
  const { list, pagination, currentPage } = state.get('attachment').toJS()
...
export default connect(mapStateToProps, mapDispatchToProps)(AttachmentListPage);